...
// zhou: event here are not the k8s Event resource. These events are controller-runtime definitions.
...
// zhou: unknown event, e.g. events outside of cluster, operator just started.
