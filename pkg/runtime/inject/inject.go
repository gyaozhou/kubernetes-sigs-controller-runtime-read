...
// zhou: don't take care of this package anymore.
...
// zhou: "Package inject defines interfaces and functions for propagating dependencies from a ControllerManager to
...
// zhou: README, invoked by "controllerManager.SetFields()"
...
func InjectorInto(f Func, i interface{}) (bool, error) {
	...
	// zhou: does not implement Injector, that's fine.
	return false, nil
}
