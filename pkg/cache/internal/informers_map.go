...
type specificInformersMap struct {
	...
	// zhou: map of all GVK need informer
	...
	// zhou: createStructuredListWatch()/createUnstructuredListWatch()/createMetadataListWatch()
...
// zhou: failed to Get() will trigger to "addInformerToMap()"
//       manager/cluster client Get() -> delegatingClient.Get() -> "InformersMap.Get()" -> here
...
func (ip *specificInformersMap) Get(ctx context.Context, gvk schema.GroupVersionKind, obj runtime.Object) (bool, *MapEntry, error) {
	...
	// zhou: wait to sync this new informer
...
// zhou: When add informer for this gvk
...
// zhou: create ListAndWatch for typed object's informer
...
// zhou: README, using dynamic client for unstructured object.
