...
// zhou: global config for controller used in manager, could be set in each controller also.
...
// zhou: why use CRD format here ?  It looks not be stored in apiserver.
